...
async def test_all_operations(dut):
    ...
    add_cases = [(10, 20), (5, -15), (0, 0), (-15, 5)]
    sub_cases = [(20, 10), (5, -10), (0, 0), (-10, 5)]
    xor_cases = [(30, 30), (0b1010, 0b1100), (0, 0), (-15, -15), (-5, 35), (35, -5)]
    or_cases = [(0b10101010, 0b11001100), (5, 10), (0, 1), (-5, -6), (-5, 10), (10, -5)]
    not_cases = [7, 0xFFFFFFFF, 0, -9]
    gt_cases = [(15, -25), (5, 5), (-1, 1), (1, -1)]
    gte_cases = [(20, -30), (5, 5), (0, 1), (-30, 20)]
    mul_cases = [(15, 13), (-7, 3), (0, 100), (-1, 6), (6, -1)]
    div_cases = [(100, 7), (15, 5), (30, -6), (-30, -5), (-30, 6)]
    equ_cases = [(15, 15), (5, 10), (0, 0), (-15, -15), (-5, 35), (35, -5)]
